...
"`r`nAttempting to download latest PowerShell 3.0 installer from Microsoft..." | Write-Host

# Create the download URL based on the windows version/architecture
$baseURL = "https://download.microsoft.com/download/E/7/6/E76850B8-DA6E-4FF5-8CCE-A24FC513FD16/" 
...
else
{
  ...
  "`r`nAttempting to install PowerShell 3.0..." | Write-Host
