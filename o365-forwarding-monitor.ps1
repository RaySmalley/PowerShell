...
Write-Host "Please enter Office 365 admin credentials."`n
...
Write-Host "Getting the Exchange Online cmdlets..."`n
...
if ($oldTransportRule) {
    ...
    Write-Host "Removed old transport rule: ""$oldTransportRule""."`n
}
