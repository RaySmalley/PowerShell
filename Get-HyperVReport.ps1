...
<#
	.SYNOPSIS
		...
		Version History:
			...
			[x] Version 1.9 - 09.November.2017 - RHE: Change Date & Time Format
			[ ] Version 1.8 - 08.November.2017 - RHE: Fix Incompatible Module Hyper-V (Import-Module Hyper-V 1.1)
			[ ] Version 1.7 - 23.Oktober.2017 - RHE: Output Filename Changes ($Cluster + "-" +)
			[ ] Version 1.6 - 20.Oktober.2017 - RHE: Minor fixes (Hyper-V\Get-VM & ($Cluster-Name HTML-Output)
...
Param (
    ...
    [parameter(
                ...
                [string]$ReportFilePath = "\\fppw0034\Source\Reports\Hyper-V Cluster Capacity Report", #(Get-Location).path,
